                                ...
                                <div className="display-flex flex-col flex-grow post-body-wrap">
                                    <div className="post-body-container position-rel display-block box-sizing">
                                        <div className="position-rel display-block box-sizing line-height-2">
                                            ...
                                            <p className="mask-text-line3 m-t-8 post-content">{post.description}</p>
                                            <div className="mask-text-line3 m-t-8 post-content font-size-5">{post.location}</div>
                                            <div className="display-flex flex-algn-center post-date neutral-color-2">
                                                <div className="display-flex m-t-4 font-size-5">{getCurrentDate(post.dateFrom)} - {getCurrentDate(post.dateTo)}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
