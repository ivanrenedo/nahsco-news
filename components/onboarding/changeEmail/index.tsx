...
import { ChangeEmailComponent } from '@generated/graphql';
        ...
        <>  
            <main className="auth-form-container m-t-0 display-flex flex-col flex-algn-center position-rel">
                <button type='button' className="display-flex flex-algn-center exit-config-container" onClick={onPersonalInfo}>
                    <span className="label font-weight-1ç3 font-size-3">Cambiar email</span>
                                ...
                                onSubmit={(data, { setSubmitting, resetForm }) => {
                                    ...
                                    changeEmail({
                                        ...
                                        .then(respuesta => { 
                                            ...
                                            const errors = respuesta.data?.changeEmail!.errors;
                                            const experience = respuesta.data?.changeEmail!.User;
                                            const errores = {
                                                name: "",
                                                message: ""
                                            };
                                        ...
                                        <Form className="form position-rel">
                                            <label className="input-label">
                                                <div className="input-label-2">
                                                    <span className='let-Spac-button font-weight-3'>Nuevo correo</span>
                                                    <div 
...
export default StartChangeEmail